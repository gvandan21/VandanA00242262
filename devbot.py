...
if choice == "N" or choice == "n":
  ...
  accessToken = "Bearer " + accessToken
	...
	accessToken = "Bearer YzRhZTFkZDctMTIxMy00NTk0LTk2ZTYtNDA0ZDY3NjMzNTUyZWEwOGE2OGUtNmNl_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "ei58bU8c9YsJfwf5CgD6FWaq6LnVtG9F"
                               }
...
# 10. Provide the Sunrise/Sunset key value for day_length
        ...
        sunriseTime = "12:58:37 AM"
        sunsetTime =  "9:40:12 PM"

# 11. Complete the code to format the response message.
        responseMessage = "In { Sudbury, ON } the sun will rise at {12:58:37 PM} and will set at { 9:40:12 PM} . The day will last {08:41:35} seconds.".format(locationResults, risetimeInFormattedString, durationInSeconds)
